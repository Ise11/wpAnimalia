  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery2.default.getJSON(animaliaData.root_url + '/index.php/wp-json/animalia/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join('') + "\n            " + (results.tutors.length ? '</ul>' : '') + "\n\n          </div>\n          <div class=\"col-md-4\">\n        <h2 class=\"search-overlay__section-title\">Events</h2>\n            " + (results.events.length ? '' : "<p>No events match that search. <a href=\"" + animaliaData.root_url + "/events\">View all events</a></p>") + "\n              " + results.events.map(function (item) {
          return "\n                <div class=\"event-summary\">\n                  <a class=\"event-summary__date bg-dark t-center\" href=\"" + item.permalink + "\">\n                    <span class=\"event-summary__month\">" + item.month + "</span>\n                    <span class=\"event-summary__day\">" + item.day + "</span>  \n                  </a>\n                  <div class=\"event-summary__content\">\n                    <h5 class=\"event-summary__title headline headline--tiny\"><a href=\"" + item.permalink + "\">" + item.title + "</a></h5>\n                    <p>" + item.description + " <a href=\"" + item.permalink + "\" class=\"nu gray\">Learn more</a></p>\n                  </div>\n                </div>\n              ";
        }).join('') + "\n\n          </div>\n        </div>\n      ");
